...
def unified_dashboard(syn: DashboardData, dram: DashboardData) -> go.Figure:
    ...
    fig.add_annotation(
        ...
        x=0.5, y=0.73,
        text="Это 3D-карта местности. <b>Красная линия</b> — реальный путь (GPS). "
             "<b>Зелёная</b> — оценка TERCOM. <b>Жёлтая</b> — уточнённая (ESKF). "
             "Если линии совпадают — навигация точная.",
        **caption_style,
    )

    for row, text in [
        (2, "Срез высот под дроном. <b>Голубая линия</b> — измерено радаром. "
            "<b>Оранжевая</b> — ожидалось по карте. "
            "Чем ближе линии — тем точнее найдено положение."),
        (3, "Уверенность алгоритма. <b>Зелёная линия</b> — корреляция (1 = идеально). "
            "<b>Оранжевая</b> — доверие к оценке. "
            "Высокие значения = ответу можно верить."),
        (4, "Ошибки оценки. <b>Розовая линия</b> — ошибка по направлению (°). "
            "<b>Голубая линия</b> — ошибка по скорости (м/с). "
            "Чем ближе к нулю — тем точнее."),
        (5, "Перебор всех направлений и скоростей. <b>Яркие участки</b> — хорошие совпадения. "
            "<b>★</b> — лучшее совпадение. "
            "Чем пятно компактнее и ярче — тем увереннее ответ."),
    ]:
        fig.add_annotation(
            xref="paper", yref="paper",
            x=0.5, y=0.02,
